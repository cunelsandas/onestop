...
*/
      $check = getimagesize($_FILES["frm_image"]["tmp_name"][0]);
                ...
                $sql = "INSERT INTO $table(id,name,tel,email,province,amphur,district,moo,num_home,location,numlocation,choice1,choice2,choice3,lat,lng,post_ip,status,active)
                ...
                ,'" .$_POST['frm_location']. "','" .$_POST['frm_numlocation']. "'
                ,'" .$_POST['choice1']. "','" .$_POST['choice2']. "','" .$_POST['choice3']. "','" .$_POST['frm_lat']. "','" .$_POST['frm_lng']. "','".$_SERVER['REMOTE_ADDR']."','1','1')";
                $rs = rsQuery($sql);
                  ...
                  if ($rs) {//window.location.href='index.php';
          ...
          <div class="col-12 col-12-medium">
              ...
              <form method="post" action="#" onsubmit="return(validate());" name="myForm" enctype="multipart/form-data">
                <div class="row gtr-uniform">
                  ...
                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <label>ขอยื่นคำร้อง ขออนุญาตทำการโฆษณา โดย</label>
                  </div>
                  <!-- Break -->
                  <!-- Break -->
                  <div class="col-2 col-12-small">
                     <input type="checkbox" value="1" id="choice1" name="choice1"/>
                    <label for="choice1">ปิดทิ้ง</label>
                  </div>
                  <div class="col-3 col-12-small">
                     <input type="checkbox" value="1" id="choice2" name="choice2"/>
                    <label for="choice2">โปรยแผ่นประกาศ</label>
                  </div>
                  <div class="col-2 col-12-small">
                     <input type="checkbox" value="1" id="choice3" name="choice3"/>
                    <label for="choice3">ใบปลิว</label>
                  </div>

                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <input type="text" name="frm_location" id="frm_location" value="" placeholder="ณ. สถานที่" />
                  </div>


                  <div class="col-12 col-12-xsmall">
                    <textarea id="frm_numlocation" name="frm_numlocation" placeholder="ซึ่งตั้งอยู่บ้านเลขที่" rows="2"></textarea>
                  </div>

                  <div class="col-12 col-12-xsmall">
                  <p style="font-weight: bold;">เงื่อนไข<br>
                  1. จำเป็นต้องเสนอแผนผังแสดงเขตที่จะโฆษณา จำนวน 1 ชุด<br>
                  2. จำเป็นต้องแนบตัวอย่างของแผ่นประกาศหรือใบปลิวที่โฆษณา จำนวน 1 ชุด<br>
                  3. เมื่อครบกำหนดเวลาในหนังสืออนุญาต จะต้องทำการ เก็บ ปลด รื้อถอน ขูด ลบ หรือล้างแผ่นป้ายประกาศหรือใบปลิวออกจากบริเวณดังกล่าว<br>
                  </p>
                  </div>
                  ...
                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <label>รูปสถานที่ประกอบจุดโฆษณา </label>
  ...
  <script type = "text/javascript">
        ...
        function validate() {
           ...
           if(choice1.checked == "" && choice2.checked == "" && choice3.checked == "") {
              alert( "กรุณาเลือก รูปแบบการโฆษณา!" );
           ...
           if( document.myForm.frm_numlocation.value == "" ) {
              alert( "กรุณากรอก ที่อยู่สถานที่!" );
              document.myForm.frm_numlocation.focus() ;
              return false;
           }
