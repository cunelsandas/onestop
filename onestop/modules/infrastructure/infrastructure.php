              ...
              <form method="post" action="#" onsubmit="return(validate());" name="myForm" enctype="multipart/form-data">
                <div class="row gtr-uniform">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="frm_subject" id="frm_subject" value="" placeholder="เรื่อง" />
                  </div>
                  <div class="col-12 col-12-xsmall">
                    <h3>ข้อมูลผู้แจ้ง</h3>
                  </div>
                  ...
                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <label>มีความประสงค์ให้<?php echo $customer_name; ?> ซ่อมแซมสาธารณูปโภค</label>
                  </div>
                  <!-- Break -->

                  <!-- Break -->
                  <div class="col-3 col-12-xsmall">
                    <select name="frm_type" id="frm_type">
                      <option value="">- ประเภท -</option>
                    <?php
                      $sql = "SELECT * FROM tb_infrastructure_type";
                      $rs = rsQuery($sql);
                      while ($row = mysqli_fetch_array($rs)) {
  ...
  <script type = "text/javascript">
        ...
        function validate() {
          ...
          if( document.myForm.frm_subject.value == "" ) {
           ...
           if( document.myForm.frm_type.value == "" ) {
              alert( "กรุณาเลือก ประเภทสาธารณูปโภค!" );
              document.myForm.frm_type.focus() ;
              return false;
           }
