          ...
          <div class="col-12 col-12-medium">
              ...
              <form method="post" action="#" onsubmit="return(validate());" name="myForm" enctype="multipart/form-data">
                <div class="row gtr-uniform">
                  ...
                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <label>มีความประสงค์ให้<?php echo $customer_name; ?> ซ่อมแซมประปา</label>
                  </div>
                  <!-- Break -->
                  ...
                  <!-- Break -->
                  <div class="col-12 col-12-xsmall">
                    <label>สถานที่หรือจุดอ้างอิง (จุดซ่อมประปา)</label>
                  </div>
                  <!-- Break -->

                  <!-- Break -->
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="p1" id="p1" value="" placeholder="จุดอ้างอิง(บริเวณที่อยู่ของท่อ สถานที่ใกล้เคียง เป็นต้น) " />
                  </div>
<!--                  <div class="col-6 col-12-xsmall">-->
