...
<div class="container">
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <?php
        $sql2 = "select * from tb_khruphan_obj where khruphan_id = $id";
        $rs2 = rsQuery($sql2);

        while ($row2 = mysqli_fetch_array($rs2)) {
          if ($row2['object_name'] != "") {
            echo "&nbsp;&nbsp;&nbsp;&nbsp;".$row2['object_name']." &nbsp;&nbsp;จำนวน&nbsp; ".$row2['num_object'] . "<br>";
          }
        }
       ?>
       <br>
      <p> วันที่มารับ &nbsp;&nbsp;&nbsp; : <?php echo DateThai($row['start_date']) ?> </p>
      <p> วันที่ส่งคืน &nbsp;&nbsp;&nbsp;&nbsp;: <?php echo DateThai($row['end_date']) ?> </p>
      <p> ใช้ในงาน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row['for_work'] ?> </p>
      <p> จัดที่ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <?php echo $row['location'] ?></p>
    </div>
</div>
</div>
  </div>
