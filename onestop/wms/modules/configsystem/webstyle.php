 ...
 <div class="content-box">
  <form name="frmnews" method="POST" action="" enctype="multipart/form-data">
	...
	<br>
		...
		<tr>
			<td></td><td><input type="submit" name="btsave" ="save">&nbsp;&nbsp;&nbsp;
                <input type="submit" name="btreset" value="reset" title="คืนค่าเป็น Default"
                       onclick="return confirm('คุณต้องการคืนค่ากลับไปเป็นค่า Default ใช่หรือไม่');"></td>
		</tr>
	</table>
