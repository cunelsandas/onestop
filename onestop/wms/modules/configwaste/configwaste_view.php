...
<div class="container">
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      <p> บ้าน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $row['num_home1'] ?> หลัง</p>
      <p> ห้องเช่า, บ้านเช่า, บ้านจัดสรร, อพาทเมนต์ : <?php echo $row['num_home2'] ?> ห้อง/หลัง</p>
      <p> ถังขยะจำนวน &nbsp;&nbsp; : <?php echo $row['num_bin'] ?> ถัง</p>
    </div>
</div>
</div>
  </div>
