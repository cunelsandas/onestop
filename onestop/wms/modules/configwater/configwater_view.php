  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      ...
      if ($home_type2 == "1") {
       ...
       ?>
      <p> ต้องการน้ำในการ &nbsp;&nbsp; <img style="width: 20px;" src="<?php echo $chack1; ?>">อุปโภค &nbsp;&nbsp;<img style="width: 20px;" src="<?php echo $chack2; ?>">บริโภค</p>
      <p> เพื่อใช้ในการ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $row['for_work'] ?> </p>
      <p> จำนวน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $row['num_tonne'] ?> &nbsp;เที่ยวรถ, <?php echo $row['num_liter'] ?> &nbsp;ลิตร</p>
      <p> ในวันที่ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo DateThai($row['date']) ?> </p>
      <p> โดนนำส่ง &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <?php echo $row['location'] ?> &nbsp;&nbsp;หมู่ที่  <?php echo $row['moo2'] ?> </p>
    </div>
</div>
</div>
  </div>
