<?php
  ...
  $modtype=FindRS("select * from tb_mod where modtype='$mod'",modtype);
  ...
  if(isset($_POST['Submit'])) {
    ...
    if ($row != 0) {
      ...
      echo "<script>alert('เลขคำร้องของท่านไม่ถูกต้อง กรุณาตรวจสอบค่ะ');window.location.href='index.php?_mod=".encode64($modtype)."';</script>";
    }
