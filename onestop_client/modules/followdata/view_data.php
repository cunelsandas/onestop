              ...
              <form method="post" action="#" onsubmit="return(validate());" name="myForm" enctype="multipart/form-data">
                ...
                <div class="row gtr-uniform">
                  ...
                  <div class="col-12 col-12-xsmall">
                    ...
                    <i class="fa fa-print" aria-hidden="true"></i><a class="btn btn-default"  href="wms/report/configbuilding/report.php?id=<?php echo $row['master_id'];?>" target="_Blank">พิมพ์คำขออนุญาตก่อสร้างอาคาร ดัดแปลงอาคารหรือรื้อถอนอาคาร (เฉพาะผู้ลงข้อมูลบน One Stop Service)</a>&nbsp;&nbsp;
