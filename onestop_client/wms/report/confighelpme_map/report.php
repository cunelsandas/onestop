...
$code=trim($_GET['id']);
$result=rsQuery("Select * from tb_help_maps Where id=$code");
if (!$result) {
    ...
    $receiveno = FindRS("SELECT * FROM tb_request WHERE table_name='tb_help_maps' AND master_id = '$code'",receiveno);
    $datein = FindRS("SELECT * FROM tb_request WHERE table_name='tb_help_maps' AND master_id = '$code'",datein);


    $id="คำร้องออนไลน์เลขที่ ".$receiveno;
...
echo '<div class="page">
							...
							<table height="100%" width="100%" border="0">
								...
								<caption style="padding: 20px"><h3> คำร้องทุกข์ออนไลน์ </h3></caption>
								<tr>
									<td width="50%">'.$id.'</td><td style="padding: 10px 0px 10px 0px;" align="right">'.$datepost.'</td>
								</tr>

								<tr>
									<td colspan="2">เรื่อง&nbsp;&nbsp;&nbsp;&nbsp; '.$row['title'].' </td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;
                  มีความประสงคแจ้งคำร้องทุกข์ โดยมีรายละเอียดดังนี้
								</tr>
                <tr>
									<td colspan="2">'.$row['content'].'</td>
								</tr>
                <tr>
									<td colspan="2" align="center" style="padding:20px">จึงเรียนมาเพื่อโปรดพิจารณา</td>
								</tr>
                ...
                <tr>
                <td></td> <td align="center">ข้าพเจ้า '.$row['name'].'</td>
                </tr>
...
<?php
$sqls  =  "select * from files_image where table_name='tb_help_maps' and master_id='$code' ";
$rss = rsQuery($sqls);
...
?>
        ...
        <tr><td align="center"><h2 style="margin-bottom:0px">รูปภาพประกอบ</h2>
                        ...
                        src='../../../fileupload/im_help/".$rows['file_name']."'>";
                            $count++;
                        }
                        ?>
        </td></tr>
